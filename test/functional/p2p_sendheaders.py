...
class SendHeadersTest(BitcoinTestFramework):
    ...
    def mine_blocks(self, count):
        ...
        self.generatetoaddress(self.nodes[0], count, self.nodes[0].get_deterministic_coinbase_address())
    ...
    def mine_reorg(self, length):
        ...
        self.generatetoaddress(self.nodes[0], length, self.nodes[0].get_deterministic_coinbase_address())
        ...
        all_hashes = self.generatetoaddress(self.nodes[1], length + 1, self.nodes[1].get_deterministic_coinbase_address())  # Must be longer than the orig chain
    ...
    def test_null_locators(self, test_node, inv_node):
        tip = self.nodes[0].getblockheader(self.generatetoaddress(self.nodes[0], 1, self.nodes[0].get_deterministic_coinbase_address())[0])
