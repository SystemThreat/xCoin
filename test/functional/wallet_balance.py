...
from test_framework.address import ADDRESS_UNSPENDABLE as ADDRESS_WATCHONLY
...
class WalletTest(BitcoinTestFramework):
    ...
    def skip_test_if_missing_module(self):
        self.skip_on_xcoin(
            "balances of coins paid to bcrt1q addresses")
    ...
    def run_test(self):
        ...
        self.generatetoaddress(self.nodes[0], 5, self.nodes[0].get_deterministic_coinbase_address())
