...
class TransactionTimeRescanTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        self.num_nodes = 3
        # xCoin: a keypool of 100, not upstream's 400. Every witness v3 address costs an
        # ML-DSA-65 and an SLH-DSA key generation (~60 ms per chain), so a 400-address
        # look-ahead made the node's createwallet run past the 30 s RPC timeout; the
        # test hands out four addresses.
