...
class LoadblockTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        with open(cfg_file, "a") as cfg:
            ...
            # This chain's regtest magic, not Bitcoin's: linearize-data.py
            # scans the block files for it and spins forever if it never matches.
            cfg.write(f"netmagic={MAGIC_BYTES['regtest'].hex()}\n")
