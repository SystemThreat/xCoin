...
class P2PFingerprintTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        block_hashes = self.generatetoaddress(self.nodes[0], 10, self.nodes[0].get_deterministic_coinbase_address())
        ...
        block_hash = int(self.generatetoaddress(self.nodes[0], 1, self.nodes[0].get_deterministic_coinbase_address())[-1], 16)
