...
class ZMQTest (BitcoinTestFramework):
    ...
    def test_basic(self, unix = False):
        ...
        genhashes = self.generatetoaddress(self.nodes[0], num_blocks, ADDRESS_UNSPENDABLE)
        ...
        self.generatetoaddress(self.nodes[0], 1, ADDRESS_UNSPENDABLE)
        hashtx.receive()
        txid = hashtx.receive()
        assert_equal(payment_txid, txid.hex())
    ...
    def test_reorg(self):
        ...
        disconnect_block = self.generatetoaddress(self.nodes[0], 1, ADDRESS_UNSPENDABLE, sync_fun=self.no_op)[0]
        ...
        connect_blocks = self.generatetoaddress(self.nodes[1], 2, ADDRESS_ANYONECANSPEND, sync_fun=self.no_op)
    ...
    def test_sequence(self):
        ...
        dc_block = self.generatetoaddress(self.nodes[0], 1, ADDRESS_UNSPENDABLE, sync_fun=self.no_op)[0]

        # Note: We are not notified of any block transactions, coinbase or mined
        assert_equal((self.nodes[0].getbestblockhash(), "C", None), seq.receive_sequence())

        # Generate 2 blocks in nodes[1] to a different address to ensure a chain split
        self.generatetoaddress(self.nodes[1], 2, ADDRESS_ANYONECANSPEND, sync_fun=self.no_op)
        ...
        c_block = self.generatetoaddress(self.nodes[0], 1, ADDRESS_UNSPENDABLE)[0]
        ...
        self.generatetoaddress(self.nodes[1], 1, ADDRESS_UNSPENDABLE)
    ...
    def test_multiple_interfaces(self):
        ...
        # Generate 1 block in nodes[0] and receive all notifications
        self.generatetoaddress(self.nodes[0], 1, ADDRESS_UNSPENDABLE, sync_fun=self.no_op)
