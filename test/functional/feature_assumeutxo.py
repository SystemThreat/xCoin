    ...
    def test_invalid_snapshot_scenarios(self, valid_snapshot_path):
        ...
        for [magic, name, real] in invalid_magics:
            ...
            if real:
                ...
                assert_raises_rpc_error(parsing_error_code, "Unable to parse metadata: This snapshot has been created for an unrecognized network. This could be a new testnet or possibly caused by data corruption.", node.loadtxoutset, bad_snapshot_path)
