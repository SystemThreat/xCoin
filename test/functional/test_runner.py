...
BASE_SCRIPTS = [
    # xCoin re-genesis (contrib/regenesis/REGENESIS.md)
    'xcoin_v3_wallet.py',
    'xcoin_reindex_genesis.py',
...
def check_script_prefixes():
    ...
    good_prefixes_re = re.compile("^(example|feature|interface|mempool|mining|p2p|rpc|wallet|tool|xcoin)_")  # xcoin_: the re-genesis tests
