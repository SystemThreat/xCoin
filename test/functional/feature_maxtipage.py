...
class MaxTipAgeTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        # xCoin: this test counts absolute block heights and needs no mined
        # coins, so it starts from the genesis block; the framework does not
        # mine block 1 for it (test_framework.py, setup_nodes).
        self.num_nodes = 2
