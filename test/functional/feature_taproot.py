...
class TaprootTest(BitcoinTestFramework):
    ...
    def skip_test_if_missing_module(self):
        self.skip_on_xcoin(
            "Taproot: BIP-341/342 key- and script-path spends over Schnorr keys. This chain has no witness v1 output at all (bad-txout-not-pq) and its script tree is witness v3 with ML-DSA-65 and SLH-DSA leaves (xcoin_v3_tests, xcoin_v3_wallet.py)")
