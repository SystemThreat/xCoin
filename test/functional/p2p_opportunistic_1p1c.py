...
class PackageRelayTest(BitcoinTestFramework):
    def skip_test_if_missing_module(self):
        self.skip_on_xcoin(
            "MiniWalletMode.RAW_P2PK and modifiable scriptSigs; a P2PK output is refused here (bad-txout-not-pq)")
    ...
    def create_tx_below_mempoolminfee(self, wallet, utxo_to_spend=None):
        """Create a 1-input minrelaytxfee-rate (1sat/vB) transaction using a confirmed UTXO. Decrement and use
    ...
    def test_orphan_consensus_failure(self):
        ...
        address = node.get_deterministic_coinbase_address()
