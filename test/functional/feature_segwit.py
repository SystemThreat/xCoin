...
class SegWitTest(BitcoinTestFramework):
    ...
    def skip_test_if_missing_module(self):
        self.skip_on_xcoin(
            "P2SH, P2WPKH and P2WSH outputs and the segwit activation story, none of which this chain has: witness v0 and v1 outputs are refused (bad-txout-not-pq)")
    ...
    def run_test(self):
        ...
        assert_equal(tmpl['weightlimit'], 16000000)
