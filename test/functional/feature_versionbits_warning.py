...
# xCoin (contrib/regenesis/REGENESIS.md section 7): top bits 01 in 31..30, and
# bits 28..29 are the PoW-algorithm id, so the deployment bits are 0..27 and
# TESTDUMMY sits on 27 on regtest.
VB_TOP_BITS = 0x40000000
VB_UNKNOWN_BIT = 26       # Choose a bit unassigned to any deployment (27 is TESTDUMMY here)
...
class VersionBitsWarningTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        node_deterministic_address = node.get_deterministic_coinbase_address()
