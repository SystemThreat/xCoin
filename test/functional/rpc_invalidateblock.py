...
from test_framework.address import ADDRESS_UNSPENDABLE_DESCRIPTOR
...
class InvalidateTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        blocks = self.generatetodescriptor(self.nodes[1], 10, ADDRESS_UNSPENDABLE_DESCRIPTOR, sync_fun=self.no_op)
