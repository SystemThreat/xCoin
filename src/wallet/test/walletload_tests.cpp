...
public:
    ...
    bool ToExportString(const SigningProvider& provider, std::string& out, const DescriptorCache* cache = nullptr) const override { return false; }
    std::optional<int64_t> RangeSize() const override { return {}; }
...
BOOST_FIXTURE_TEST_CASE(wallet_load_descriptors, TestingSetup)
{
...

    {
        ...
        WalletBatch batch(*database);
        // The upstream descriptor re-encoded with NEX's xpub version bytes
        // (and its checksum refreshed accordingly).
        std::string desc = "wpkh([d34db33f/84h/0h/0h]v28XeHN1fPM8Xk2mvMDhR7qv5baC1jqR6WaVuazxegBqqoyBEPMQVTiKCQrQfP85hGrKLVTFXiqoB5C6UP1DALzjm9gnQ1yycRcAwJvG4V8zPjE/0/*)#3shskj2t";
