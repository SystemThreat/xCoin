...
static void DuplicateInputs(benchmark::Bench& bench)
{
    ...
    // xCoin: a bare OP_TRUE output is consensus-invalid (bad-txout-not-pq) and
    // that check runs BEFORE the duplicate-input check this benchmark measures,
    // so the outputs have to be the anyone-can-spend witness v3 script.
    const CScript SCRIPT_PUB{XcoinV3OpTrueScript()};
