...
enum opcodetype
{
    ...
    OP_NOP4 = 0xb3,
    OP_CHECKTEMPLATEVERIFY = OP_NOP4, //!< BIP-119 semantics inside xCoin witness v3 PQ leaves only; NOP elsewhere
    OP_NOP5 = 0xb4,
    OP_NOP6 = 0xb5,
    OP_NOP7 = 0xb6,
    OP_NOP8 = 0xb7,
    ...
    // NEX post-quantum signature verification (ML-DSA-65)
    OP_CHECKSIG_PQ = 0xbb,
    OP_CHECKSIGVERIFY_PQ = 0xbc,
...
public:
    ...
    /*
     * OP_3 <32-byte Merkle root>: xCoin witness v3 (post-quantum script tree)
     */
    bool IsPayToXcoinV3() const;
