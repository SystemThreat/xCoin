    ...
    inline void Unserialize(Stream& s) {
        ...
        if (!std::equal(message.begin(), message.end(), m_network_magic.data())) {
            ...
            if (metadata_network) {
                ...
                throw std::ios_base::failure("This snapshot has been created for an unrecognized network. This could be a new testnet or possibly caused by data corruption.");
            }
        }
