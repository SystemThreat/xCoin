...
{
    // Raw key bytes of the upstream vector's WIF
    // ("5Kg1gnAjaLfKiwhhPpGS3QfRg2m6awQvaj98JCZBZQ5SuS2F15C", uncompressed) —
    // that encoding uses Bitcoin's SECRET_KEY version byte, which NEX changed,
    // so DecodeSecret() can no longer parse it.
    constexpr auto secret{"f49addfd726a59abde172c86452f5f73038a02f4415878dc14934175e8418aff"_hex};
    CKey key;
