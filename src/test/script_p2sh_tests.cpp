...
{
    return IsStandardTx(tx, std::nullopt, permit_bare_multisig, /*permit_v2_outputs=*/true, CFeeRate{DUST_RELAY_TX_FEE}, reason);
}

static bool IsStandardTx(const CTransaction& tx, std::string& reason)
{
    return IsStandardTx(tx, std::nullopt, /*permit_bare_multisig=*/true, /*permit_v2_outputs=*/true, CFeeRate{DUST_RELAY_TX_FEE}, reason) &&
           IsStandardTx(tx, std::nullopt, /*permit_bare_multisig=*/false, /*permit_v2_outputs=*/true, CFeeRate{DUST_RELAY_TX_FEE}, reason);
}
