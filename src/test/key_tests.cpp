...
// The upstream key/address vectors re-encoded for NEX's base58 version bytes
// (SECRET_KEY=181, PUBKEY_ADDRESS=53); the underlying key material is
// unchanged from upstream.
static const std::string strSecret1 = "74yyHDTbmFNph2cp6cCiV6SsgmsDBKnrzYeTVfjoMVcGfoTLccE";
static const std::string strSecret2 = "76DX12duuTr5Aj5KRm243CnkZRBfXeR59EjcwijUhDcn7CyuPhK";
static const std::string strSecret1C = "TnaTQZzQSJTKVg94skNi713CiZ2ckZwRezgKwXyubTGgA2BLcYpz";
static const std::string strSecret2C = "Tt2FR8DvWZVbPvi4LHHeQj2wG5k54G9FHMd7eXCVEWgv65PwKoFk";
...
// A Bitcoin-prefix address: decodes as neither a NEX secret nor a NEX address.
