        ...
        "\nRelated RPCs: createrawtransaction, signrawtransactionwithkey\n",
        {
            ...
            {"maxfeerate", RPCArg::Type::AMOUNT, RPCArg::Default{FormatMoney(DEFAULT_MAX_RAW_TX_FEE_RATE.GetFeePerK())},
             "Reject transactions whose fee rate is higher than the specified value, expressed in " + CURRENCY_UNIT +
                 "/kvB.\nFee rates larger than 1 " + CURRENCY_UNIT + "/kvB are rejected.\nSet to 0 to accept any fee rate."},
...
UniValue MempoolInfoToJSON(const CTxMemPool& pool)
{
    ...
    ret.pushKV("permitv2outputs", pool.m_opts.permit_v2_outputs);
    ...
    return RPCHelpMan{"getmempoolinfo",
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::BOOL, "permitv2outputs", "True if the mempool accepts transactions creating new legacy witness v2 outputs"},
