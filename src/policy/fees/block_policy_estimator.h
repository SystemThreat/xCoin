...
private:
     ...
     *
     * xCoin: DEFAULT_MIN_RELAY_TX_FEE is 1,000 (1 sat/vB, founder decision 2026-09-15)
     * while this stays at 100, deliberately: a node that lowers -minrelaytxfee still gets
     * estimates down to 0.1 sat/vB, and the fee-estimate file format does not change.
     */
