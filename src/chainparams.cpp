...
void ReadRegTestArgs(const ArgsManager& args, CChainParams::RegTestOptions& options)
{
    ...
    if (args.IsArgSet("-levybp")) options.levy_bp = args.GetIntArg("-levybp", Consensus::SETTLEMENT_LEVY_BP);
    if (args.IsArgSet("-coinbasematurity")) options.coinbase_maturity = args.GetIntArg("-coinbasematurity", Consensus::COINBASE_MATURITY_MAINNET);
