...
{
    // xCoin (XCF) emission (contrib/regenesis/REGENESIS.md section 2, consensus/params.h):
    // block 0 mints nothing; from block 1 every block pays the era subsidy from this
    // chain's table: 14 XCF for era 0, halved every 750,000 blocks in whole satoshis,
    // 31 eras, to EmissionEndHeight(). That block alone additionally mints the closing
    ...
    // is carried in. O(eras): 31 on mainnet.
