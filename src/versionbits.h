 ...
 *  xCoin v2 (REGENESIS.md section 7): the BIP9 top bits are 01 in bits 31..30
 *  (Bitcoin uses 001 in bits 31..29) because bits 29..28 are reserved for the
 *  PoW-algorithm id (Consensus::POW_ALGO_ID_MASK), which must be 0 until the
 *  multi-algorithm activation. Deployment bits are 0..27. */
static const int32_t VERSIONBITS_TOP_BITS = 0x40000000UL;
/** What bitmask determines whether versionbits is in use */
static const int32_t VERSIONBITS_TOP_MASK = 0xC0000000UL;
/** Total bits available for versionbits (bits 28 and 29 belong to the PoW-algorithm id) */
