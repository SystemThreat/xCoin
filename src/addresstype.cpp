...
bool ExtractDestination(const CScript& scriptPubKey, CTxDestination& addressRet)
{
    ...
    case TxoutType::WITNESS_V3_PQ: {
        WitnessV3PQ v3;
        std::copy(vSolutions[0].begin(), vSolutions[0].end(), v3.begin());
        addressRet = v3;
        return true;
    }
...
public:
    ...
    CScript operator()(const WitnessV2PQ& id) const
    {
        return CScript() << OP_2 << ToByteVector(id);
    }

    CScript operator()(const WitnessV3PQ& id) const
    {
...
public:
    ...
    bool operator()(const WitnessV3PQ& dest) const { return true; }
