...
between height 20000 and 38000 on testnet while logging all blocks that take
...
In a different terminal, starting the node on testnet and with
re-indexing enabled.

```
$ ./build/bin/bitcoind -testnet -reindex
```
